<script lang="ts">
import redditFavicon from '@/assets/reddit-favicon-64.png';
...
let { platform, sizeClass = 'size-4' }: Props = $props();
</script>

{#if platform === 'hn'}
  <span class="inline-flex items-center justify-center rounded-sm bg-[#ff6600] text-[0.6rem] font-bold leading-none text-white {sizeClass}">
    Y
  </span>
